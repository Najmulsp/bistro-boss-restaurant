...
import OurMenu from "../home/PopularMenu";
...
const Menu = () => {
    ...
    return (
        <div>
            ...
            <div className="mt-10">
            <MenuItems items={desserts} btnText="Order Your Favorite Food"></MenuItems>
            </div>
            </div>
            {/* Pizza */}
            <div className="mt-10">
            <Cover img={coverImg2} title="PIZZAS" details="Sautéed breaded veal escalope with watercress, lemon and veal jus.">
            </Cover>
            <div className="mt-10">
            <MenuItems items={desserts} btnText="Order Your Favorite Food"></MenuItems>
            </div>
            ...
            {/* Salad */}
            <div className="mt-10">
            <Cover img={coverImg2} title="SALADS" details="Warm goats cheese and roasted vegetable salad with black olive tapenade crostini.">
            </Cover>
            <div className="mt-10">
            <MenuItems items={desserts} btnText="Order Your Favorite Food"></MenuItems>
            </div>
            ...
            {/* Soup */}
            <div className="mt-10">
            <Cover img={coverImg2} title="SOUPS" details="Pan roasted pork belly with gratin potato, braised Savoy cabbage, apples, thyme and calvados jus.">
            </Cover>
            <div className="mt-10">
            <MenuItems items={desserts} btnText="Order Your Favorite Food"></MenuItems>
            </div>
